...
public record HuggingFaceProperties(String apiToken, String modelName, Integer topK, Float topP, Float temperature,
		Float repetitionPenalty, Integer maxNewTokens, Float maxTime, Boolean returnFullText,
		Integer numReturnSequences, Boolean doSample, Options options) {
	...
	public HuggingFaceProperties {
		...
		repetitionPenalty = (repetitionPenalty != null) ? repetitionPenalty : 1.0f; // Default
																					// value
		maxNewTokens = (maxNewTokens != null) ? maxNewTokens : 50; // Default value
		maxTime = (maxTime != null) ? maxTime : 60.0f; // Default value
		returnFullText = (returnFullText != null) ? returnFullText : true; // Default
																			// value
		numReturnSequences = (numReturnSequences != null) ? numReturnSequences : 1; // Default
																					// value
